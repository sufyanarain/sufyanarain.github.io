...
instruction.innerHTML = `Popup ${colors[rand2]} Balloons`
                ...
                balloon[i].addEventListener('mouseover', (e) => {
                    if (e.target.className.includes(colors[rand2])) {
                        ...
                        if (score == 200) {
                            ...
                            balloonDiv.innerHTML = `<div><h1 class="text-center">you Won!</h1><a onclick="pushDataFireStore('${score}','${user.uid}')" href="level5.html" class="btn btn-primary" id="startAgain">Next Level</a></div><br>`
                        ...
                        if (lives == 0) {
                            ...
                            balloonDiv.innerHTML = `<h1>game over<h1><br><a href="level4.html" class="btn btn-primary" id="startAgain">Start Again</a>`
