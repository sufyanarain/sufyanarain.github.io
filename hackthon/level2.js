                ...
                balloon[i].addEventListener('mouseover', (e) => {
                    if (e.target.className.includes(colors[rand2])) {
                        ...
                        if (score == 100) {
                            ...
                            balloonDiv.innerHTML = `<h1>you Won!</h1><br><a onclick="pushDataFireStore('${score}','${user.uid}')" href="level3.html" class="btn btn-primary" id="startAgain">Level 3</a>`
                        ...
                        if (lives == 0) {
                            ...
                            balloonDiv.innerHTML = `<h1>game over<h1><br><a href="level2.html" class="btn btn-primary" id="startAgain">Start Again</a>`
