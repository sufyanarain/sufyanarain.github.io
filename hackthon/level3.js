                ...
                balloon[i].addEventListener('mouseover', (e) => {
                    if (e.target.className.includes(colors[rand2])) {
                        ...
                        if (score == 150) {
                            ...
                            balloonDiv.innerHTML = `<h1>you Won!</h1><br><a onclick="pushDataFireStore('${score}','${user.uid}')" href="level4.html" class="btn btn-primary" id="startAgain">Level 4</a>`
                        ...
                        if (lives == 0) {
                            ...
                            balloonDiv.innerHTML = `<h1>game over<h1><br><a href="level3.html" class="btn btn-primary" id="startAgain">Start Again</a>`
